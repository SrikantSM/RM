...
for (let i = 1; i < 181; i++) {
	...
	assignmentBucket.push({
		ID: uuid(),
		assignment_ID: assignments.assignment9.ID,
	...
	assignmentBucket.push({
		ID: uuid(),
		assignment_ID: assignments.assignment10.ID,
		startTime: dynamicDateGenerator.getCurrentDay(i),
		bookedCapacityInMinutes: 120
	});
	// For 3rd Assignment
	assignmentBucket.push({
		ID: uuid(),
		assignment_ID: assignments.assignment11.ID,
		startTime: dynamicDateGenerator.getCurrentDay(i),
	...
	assignmentBucket.push({
		ID: uuid(),
		assignment_ID: assignments.assignment12.ID,
		startTime: dynamicDateGenerator.getCurrentDay(i),
		bookedCapacityInMinutes: 60
	});
	// For 5th Assignment
	assignmentBucket.push({
		ID: uuid(),
		assignment_ID: assignments.assignment22.ID,
		startTime: dynamicDateGenerator.getCurrentDay(i),
		bookedCapacityInMinutes: 60
	});
}

...
const REPORT_NAME = 'ENV_REPORT_NAME';

//const APP_USER_PREFIX = "END_TO_END_TESTS_APP_USER_";
//const APP_PASSWORD_PREFIX = "END_TO_END_TESTS_APP_PASSWORD_";
...
module.exports = class Environment {
    ...
    get reportName() {
        return this.environmentVariables.get(REPORT_NAME);
    }

    get appUsers() {
        return new Map(
            Array.from(this.environmentVariables.entries())

...
public class DestinationResponseTest {
    ...
    public void testAllArgsConstructorAnnotation() {
        ...
        DestinationConfiguration configuration = new DestinationConfiguration(NAME,TYPE,URL,AUTHENTICATION,PROXY_TYPE,TOKEN_SERVICE_URL_TYPE,CLIENT_ID,CLIENT_SECRET,TOKEN_SERVICE_URL);
        AuthTokens authTokens = new AuthTokens(TYPE,VALUE,EXPIRES_IN,ERROR);
        DestinationResponse destinationResponse = new DestinationResponse(configuration, Collections.singletonList(authTokens));

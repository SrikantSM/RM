...
/**
 * Test Class to test working of {@link JobSchedulerVCAP}.
 */
public class JobSchedulerVCAPTest extends InitMocks {
    ...
    public void setUp() {
        ...
        when(this.cfCredentials.getString(anyString())).thenReturn(JOB_SCHEDULER_DUMMY_SERVICE_URL);
        // Creating the test object
        this.classUnderTest = new JobSchedulerVCAP(this.cfEnv);
    }
    ...
    public void prepareClientCredentialsWithX509Certificate() {
        ...
        assertEquals(JOB_SCHEDULER_DUMMY_SERVICE_URL, this.classUnderTest.getServiceUrl());

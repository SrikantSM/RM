...
class CostCenterReplicationControllerTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(CostCenterReplicationControllerTest.class);
    ...
    public CostCenterReplicationControllerTest(@Value("${local.server.port}") int localPort,
    ...
    void testIfThereIsNoPreviousRunningJobRunFound() throws IOException, InterruptedException {
        ...
        this.integrationTestHelper.setJobSchedulerMock(JOB_SCHEDULER_PREVIOUS_RUN_NOT_FOUND, MediaType.APPLICATION_JSON,
                queryParameters, X_SAP_JOB_ID, SCHEDULES, X_SAP_JOB_SCHEDULE_ID, RUNS);
        this.integrationTestHelper.setMock("MasterDataIntegration/CostCenter/" + EMPTY_MDI_RESPONSE,

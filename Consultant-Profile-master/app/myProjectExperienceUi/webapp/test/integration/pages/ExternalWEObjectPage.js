sap.ui.define(["sap/fe/test/ObjectPage", "sap/ui/test/OpaBuilder",
    ...
    'sap/ui/test/actions/Press'], function (ExternalWEObjectPage, OpaBuilder, Opa5, Properties, Press) {
    "use strict";
    var PREFIX_ID = 'myProjectExperienceUi::ExternalWorkExperienceObjectPage--';
    ...
    var AdditionalCustomObjectPageDefinition = {
        ...
        assertions: {
            ...
            iShouldSeeCorrectLabelsInGeneralInfoSection: function (aLabels) {
                return this.waitFor({
                    id: "myProjectExperienceUi::ExternalWorkExperienceObjectPage--fe::FormContainer::FieldGroup::GeneralInformation",
    ...
    return new ExternalWEObjectPage(
        {

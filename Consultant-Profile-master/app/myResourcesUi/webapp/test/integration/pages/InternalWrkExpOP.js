...
function (InternalWrkExpOP, OpaBuilder, Opa5, Properties, Press) {
    "use strict";

    var PREFIX_ID = 'myResourcesUi::InternalWorkExperienceObjectPage--';
    var AdditionalCustomObjectPageDefinition = {
        ...
        assertions: {
            ...
            iShouldSeeCorrectLabelsInGeneralInfoSection: function (aLabels) {
                return this.waitFor({
                    id: "myResourcesUi::InternalWorkExperienceObjectPage--fe::FormContainer::FieldGroup::GeneralInformation",

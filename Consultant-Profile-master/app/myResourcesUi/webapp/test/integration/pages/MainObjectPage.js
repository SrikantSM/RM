...
function (ObjectPage, OpaBuilder, Opa5, Properties, Press, EnterText) {
    "use strict";
    // OPTIONAL
    var PREFIX_ID = 'myResourcesUi::MyResourceObjectPage--';
    var AdditionalCustomObjectPageDefinition = {
        actions: {
            ...
            iClickOnMenuButtonItems: function (sId, sItem) {
                var OBJECTPAGE_PREFIX_ID = 'myResourcesUi::MyResourceObjectPage--fe::ObjectPage-anchBar-myResourcesUi::MyResourceObjectPage--';
                return this.waitFor({
    ...
    return new ObjectPage(
        {
            ...
            componentId: "MyResourceObjectPage", // MANDATORY: Compare sap.ui5.routing.targets.id in manifest.json

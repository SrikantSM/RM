...
class ProjectExperienceHeaderSkillValidatorTest extends InitMocks {
    ...
    @Autowired
    @InjectMocks
    ProjectExperienceHeaderSkillValidator classUnderTest;
    ...
    public void setUp() {
        ...
        classUnderTest = new ProjectExperienceHeaderSkillValidator(mockCommonValidator, messages,
    ...
    void validateMyProjectExperienceHeaderSkills1() {
        ...
        classUnderTest.validateProjectExperienceHeaderSkills(skillsList);
    ...
    void validateMyProjectExperienceHeaderSkills7() {
        ...
        when(mockCommonValidator.validateFreeTextforScripting(anyString())).thenReturn(true);
        when(mockCommonValidator.checkInputValueExistingDB(anyString(), anyString(), anyString())).thenReturn(true);
        assertDoesNotThrow(() -> classUnderTest.validateProjectExperienceHeaderSkills(skillsList));
    }
    ...
    void checkInputFieldLengthTooLong() {
        ...
        boolean result = classUnderTest.checkInputFieldSize(mockSkill1);
        assertFalse(result);
        verify(messages, times(1)).error(MessageKeys.SKILL_DOES_NOT_EXISTS);
    }
    ...
    void checkProficiencyLevelWithExistingProficiencyLevelOnDb() {
        ...
        assertDoesNotThrow(() -> classUnderTest
                .validateProjectExperienceHeaderSkills(Collections.singletonList(skillAssignmentRequest)));
    }
    ...
    void checkProficiencyLevelWithNotExistingProficiencyLevelOnDb() {
        ...
        classUnderTest.validateProjectExperienceHeaderSkills(Collections.singletonList(skillAssignmentRequest));

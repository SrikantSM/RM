...
class ProjectExperienceHeaderRoleValidatorTest extends InitMocks {
    ...
    @Autowired
    @InjectMocks
    ProjectExperienceHeaderRoleValidator classUnderTest;
    ...
    public void setUp() {
        ...
        classUnderTest = new ProjectExperienceHeaderRoleValidator(mockCommonValidator, messages);
    }
    ...
    void validateMyProjectExperienceHeaderRoles1() {
        ...
        this.classUnderTest.validateProjectExperienceHeaderRoles(rolesList);
    ...
    void validateMyProjectExperienceHeaderRoles2() {
        ...
        classUnderTest.validateProjectExperienceHeaderRoles(rolesList);
        verify(messages, times(2)).error(MessageKeys.INPUT_ROLE_CAN_NOT_EMPTY);
    }
    ...
    void validateMyProjectExperienceHeaderRoles7() {
        ...
        when(mockCommonValidator.checkInputValueExistingDB(anyString(), anyString(), anyString())).thenReturn(true);
        when(mockCommonValidator.validateFreeTextforScripting(anyString())).thenReturn(true);
        assertDoesNotThrow(() -> classUnderTest.validateProjectExperienceHeaderRoles(rolesList));
    }
    ...
    void validateMyProjectExperienceHeaderRoles8() {
        ...
        classUnderTest.checkInputFieldSize(mockRole1);
        verify(messages, times(1)).error(MessageKeys.ROLE_DOES_NOT_EXISTS);
    }
    ...
    void validateMyProjectExperienceHeaderRoles9() {
        ...
        assertDoesNotThrow(() -> classUnderTest.checkInputFieldSize(mockRole1));
    }

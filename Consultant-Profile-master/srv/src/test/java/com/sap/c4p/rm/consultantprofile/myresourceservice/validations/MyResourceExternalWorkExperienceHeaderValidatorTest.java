...
class MyResourceExternalWorkExperienceHeaderValidatorTest extends InitMocks {
    ...
    @Mock
    ExternalWorkExperienceSkillValidator mockExternalWorkExperienceSkillsValidator;

    Messages messages;

    @Autowired
    @InjectMocks
    MyResourceExternalWorkExperienceHeaderValidator classUnderTest;
    ...
    public void setUp() {
        ...
        classUnderTest = new MyResourceExternalWorkExperienceHeaderValidator(mockCommonValidator,
    ...
    void validateExternalWorkExperienceHeaderEmpty() {
        ...
        assertDoesNotThrow(() -> classUnderTest.validateMyResourceExternalWorkExperienceHeader(emptyList));
    }
    ...
    void validateExternalWorkExperienceHeader() {
        ...
        classUnderTest.validateMyResourceExternalWorkExperienceHeader(externalWorkExperienceList);
    ...
    void validateExternalWorkExperienceHeader13() {
        ...
        assertDoesNotThrow(
                () -> classUnderTest.validateMyResourceExternalWorkExperienceHeader(externalWorkExperienceList));
        verify(mockExternalWorkExperienceSkillsValidator, times(0))
                .validateMyResourceExternalWorkExperienceSkills(anyString(), anyList(), anyString());
    }

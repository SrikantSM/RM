...
class ExternalWorkExperienceSkillValidatorTest extends InitMocks {
    ...
    @Autowired
    @InjectMocks
    ExternalWorkExperienceSkillValidator classUnderTest;
    ...
    public void setUp() {
        ...
        classUnderTest = new ExternalWorkExperienceSkillValidator(mockCommonValidator, mockCommonUtility, messages,
    ...
    void validateExternalWorkExperienceSkills1() {
        ...
        classUnderTest.validateMyResourceExternalWorkExperienceSkills(externalExperienceID, skillsList, projectName);
    ...
    void validateExternalWorkExperienceSkills7() {
        ...
        when(mockCommonValidator.checkInputValueExistingDB(anyString(), anyString(), anyString())).thenReturn(true);
        when(mockCommonValidator.validateFreeTextforScripting(anyString())).thenReturn(true);
        assertDoesNotThrow(() -> classUnderTest.validateMyResourceExternalWorkExperienceSkills(externalExperienceID,
    ...
    void checkProficiencyLevelWithProficiencyLevelIdNull() {
        ...
        assertDoesNotThrow(() -> classUnderTest
                .validateMyResourceExternalWorkExperienceSkills(UUID.randomUUID().toString(), skillsList, projectName));
    ...
    void checkProficiencyLevelWithExistingProficiencyLevelOnDb() {
        ...
        assertDoesNotThrow(() -> classUnderTest.validateMyResourceExternalWorkExperienceSkills(id1,
    ...
    void checkProficiencyLevelWithNotExistingProficiencyLevelOnDb() {
        ...
        classUnderTest.validateMyResourceExternalWorkExperienceSkills(id1,
                Collections.singletonList(externalWorkExperienceSkill), projectName);

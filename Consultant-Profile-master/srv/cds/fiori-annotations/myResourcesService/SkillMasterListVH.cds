...
annotate MyResourcesService.SkillMasterList with {
    ID
    @(
...
annotate MyResourcesService.Catalogs2SkillsConsumption with {
    catalog @cds.search;
    // Value Help
    catalog_ID @(
      Common : {
...
annotate MyResourcesService.CatalogsConsumption with {
    // Name Filter
    name
    @(
        Search.defaultSearchElement : true,

...
const description1 = 'Resource Request for JAVA in Resource Management MR';
const description2 = 'Resource Request for Javascript in Resource Management MR';
...
const resourceRequestData2 = {
    ...
    requestedResourceOrg_ID: resourceOrganizations[1].displayId,
    processingResourceOrg_ID: resourceOrganizations[1].displayId,
    priority_code: 2,
    requestStatus_code: 1,
    releaseStatus_code: 1,
    resourceKind_code: '1',

...
const skillName1 = {
    name: `CDS test ${seleniumTestName}`,
};

const skillName2 = {
    name: `NodeJS ${seleniumTestName}`,
};

const skillName3 = {
    name: `UI5 ${seleniumTestName}`,
};

const skillName4 = {
    name: `Product Management ${seleniumTestName}`,
};

const skillName5 = {
    name: `Fiori ${seleniumTestName}`,
};

const skillName6 = {
    name: `CAP ${seleniumTestName}`,
};

const skillName7 = {
    name: `Java ${seleniumTestName}`,
};

const PriorExperience = require('./PriorExperience-Role.js');

const actions = {
    async createSkillRow() {
        const createId = 'myResourcesUi::ExternalWorkExperienceObjectPage--fe::table::externalWorkExperienceSkills::LineItem::StandardAction::Create';
    ...
    async changeErrorValueInTable(objectPage, table, valueToBeFilled) {
        const field = element(by.control({
            ...
            ancestor: {
                ...
                id: `myResourcesUi::${objectPage}--fe::table::${table}::LineItem-innerTable`,
            },
        }));
    ...
    async create(tableName) {
        const createId = `myResourcesUi::MyResourceObjectPage--fe::table::${tableName}::LineItem::StandardAction::Create`;
        const createButton = element(by.id(createId));
        await createButton.click();
    },

    async deleteSkill(valueToBeDeleted) {
        const tableId = 'myResourcesUi::ExternalWorkExperienceObjectPage--fe::table::externalWorkExperienceSkills::LineItem';
        const deleteId = 'myResourcesUi::ExternalWorkExperienceObjectPage--fe::table::externalWorkExperienceSkills::LineItem::StandardAction::Delete';
    ...
    async fillEmptyInputSubPage(valueToBeFilled) {
        ...
        const blankRow = '';
        const objectTableID = 'myResourcesUi::ExternalWorkExperienceObjectPage--fe::table::externalWorkExperienceSkills::LineItem-innerTable';
    ...
    async delete(tableName, valueToBeDeleted) {
        const tableId = `myResourcesUi::MyResourceObjectPage--fe::table::${tableName}::LineItem`;
        const deleteId = `myResourcesUi::MyResourceObjectPage--fe::table::${tableName}::LineItem::StandardAction::Delete`;
        const table = element(by.id(tableId));
        const rowsOfTable = table.all(by.control({
            controlType: 'sap.m.ColumnListItem',
        }));
    ...
    async getValueHelpItemsCount(tableName, skillName) {
        const subObjectTableID = `myResourcesUi::MyResourceObjectPage--fe::table::${tableName}s::LineItem::TableValueHelp::${tableName}_ID::Table-innerTable`;
    ...
    async changeValueOfTheRow(tableName, valueToBeChanged, newValue) {
        ...
        const subObjectTableID = `myResourcesUi::MyResourceObjectPage--fe::table::${tableName}::LineItem::TableValueHelp::${tableName}::${tableId}::Dialog::qualifier::::Table-innerTable`;
        const objectTable = element(by.id(objectTableID));
        const objectTableRows = objectTable.all(by.control({
            controlType: 'sap.m.ColumnListItem',
        }));
    ...
    async assignSkill(valueToBeChanged, newValue) {
        let elementToBeClicked;
        const objectTableID = 'myResourcesUi::ExternalWorkExperienceObjectPage--fe::table::externalWorkExperienceSkills::LineItem-innerTable';
        const subObjectTableID = 'myResourcesUi::ExternalWorkExperienceObjectPage--fe::table::externalWorkExperienceSkills::LineItem::TableValueHelp::externalWorkExperience::externalWorkExperienceSkills::skill_ID::Dialog::qualifier::::Table-innerTable';
        const objectTable = element(by.id(objectTableID));
        const objectTableRows = objectTable.all(by.control({
            controlType: 'sap.m.ColumnListItem',
        }));
    ...
    async changeValueOfTheSkillsRow(valueToBeChanged, newValue) {
        let elementToBeClicked;
        const objectTableID = 'myResourcesUi::MyResourceObjectPage--fe::table::skills::LineItem';
        const objectTable = element(by.id(objectTableID));
        const objectTableRows = objectTable.all(by.control({
            controlType: 'sap.m.ColumnListItem',
        }));
        ...
        await element(by.control({
            ...
            ancestor: {
                ...
                ancestor: {
                    ...
                    ancestor: {
                        id: `myResourcesUi::${objectPage}--fe::table::${tableName}::LineItem`,
                    },
                },
            },
        })).click();

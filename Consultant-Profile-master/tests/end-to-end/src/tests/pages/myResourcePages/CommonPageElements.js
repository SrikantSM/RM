...
const objectPage = {
    elements: {
        ...
        belowOverflowToolbarExternalWorkExperience: element(by.control({
            ...
            id: 'myResourcesUi::ExternalWorkExperienceObjectPage--fe::FooterBar',
        })),

        belowOverflowToolbar: element(by.control({
            controlType: 'sap.m.OverflowToolbar',
            id: 'myResourcesUi::MyResourceObjectPage--fe::FooterBar',
        })),
        ...
        footer: {
            saveButton: element(
                by.control({
                    id: 'myResourcesUi::MyResourceObjectPage--fe::FooterBar::StandardAction::Save',
                }),
            ),

            clickSaveButton: element(
                by.control({
                    id: 'myResourcesUi::MyResourceObjectPage--fe::FooterBar::StandardAction::Save',
                }),
            ),
            ...
            cancelButton: element(
                by.control({
                    id: 'myResourcesUi::MyResourceObjectPage--fe::FooterBar::StandardAction::Cancel',
                }),
            ),

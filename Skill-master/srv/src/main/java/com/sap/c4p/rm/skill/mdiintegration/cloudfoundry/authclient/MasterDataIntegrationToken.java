...
public class MasterDataIntegrationToken extends AbstractAuthClient {
  ...
  @Autowired
  public MasterDataIntegrationToken(@Qualifier("cacheManager") CacheManager cacheManager,
   ...
   */
  @Override
  @Cacheable(cacheManager = "cacheManager", cacheNames = Constants.MDI_OAUTH_TOKEN_CACHE_NAME, key = "#subDomain", unless = "#result == null")

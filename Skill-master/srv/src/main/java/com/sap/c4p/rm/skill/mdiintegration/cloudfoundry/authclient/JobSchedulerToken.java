...
public class JobSchedulerToken extends AbstractAuthClient {
  ...
  @Autowired
  public JobSchedulerToken(@Qualifier("cacheManager") CacheManager cacheManager,
   ...
   */
  @Override
  @Cacheable(cacheManager = "cacheManager", cacheNames = Constants.JOB_SCHEDULER_OAUTH_TOKEN_CACHE_NAME, key = "#subDomain", unless = "#result == null")

...
import com.sap.resourcemanagement.skill.integration.ReplicationErrorMessages_;
...
public class ReplicationErrorMessagesDAOImpl implements ReplicationErrorMessagesDAO {
  ...
  @Cacheable(cacheManager = "cacheManager", cacheNames = REPLICATION_ERROR_CODE_CACHE_NAME)

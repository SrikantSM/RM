...
public class DestinationVCAPTest extends InitMocks {
  ...
  public void setUp() {
    ...
    when(this.cfCredentials.getString(anyString())).thenReturn(DESTINATION_DUMMY_SERVICE_URL,
    ...
    this.classUnderTest = new DestinationVCAP(this.cfEnv);
  }
  ...
  public void prepareClientCredentials() {
    ...
    assertEquals(DESTINATION_DUMMY_SERVICE_URL, this.classUnderTest.getServiceUrl());
    assertEquals(

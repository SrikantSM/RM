...
class MessageKeyPrecompilerTest {
  ...
  void readI18nKeysExistingFile() throws PrecompilationException {
    ...
    assertTrue(keys.contains("csvColumnContentMissing"),
        "'csvColumnContentMissing' not returned by readI18nKeys as expected");
    assertTrue(keys.contains("csvColumnsMissing"), "'csvColumnsMissing' not returned by readI18nKeys as expected");
  }
  ...
  void generateMessageKeysClass() throws PrecompilationException {
    ...
    assertTrue(classCode.contains("CSV_COLUMN_CONTENT_MISSING"),
        "'CSV_COLUMN_CONTENT_MISSING' not found in class generated by generateMessageKeysClass()");
    assertTrue(classCode.contains("CSV_COLUMNS_MISSING"),
        "'CSV_COLUMNS_MISSING' not found in class generated by generateMessageKeysClass()");
  }

...
export async function deleteData() {
  ...
  await resourceRequestRepository.deleteOne(data.resourceRequest);
  await resourceRequestRepository.deleteOne(data.resourceRequestInsertedViaDB);
...
export async function insertData() {
  ...
  await resourceRequestRepository.insertOne(data.resourceRequestInsertedViaDB);

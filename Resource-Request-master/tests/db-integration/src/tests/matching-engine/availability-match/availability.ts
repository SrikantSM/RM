...
export class Availability {
  ...
  async 'Resource is available as requested'() {
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource is partially available as requested'() {
    const result = await availabilityProcedure.callProcedure(
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource is not available as requested'() {
    const result = await availabilityProcedure.callProcedure(
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource has more available minutes than requested'() {
    const result = await availabilityProcedure.callProcedure(
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource has zero availability'() {
    const result = await availabilityProcedure.callProcedure(
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource has no availability data maintained'() {
    const result = await availabilityProcedure.callProcedure(
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource has partial availability data maintained'() {
    const result = await availabilityProcedure.callProcedure(
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource Availability is partial when Work Assginment-Job Details dates are partially within the Resource Request Dates'() {
    const result = await availabilityProcedure.callProcedure(
  ...
  @test(timeout(TEST_TIMEOUT))
  async 'Resource Availability is zero when Work Assginment-Job Details dates are not within the Resource Request Dates'() {
    const result = await availabilityProcedure.callProcedure(

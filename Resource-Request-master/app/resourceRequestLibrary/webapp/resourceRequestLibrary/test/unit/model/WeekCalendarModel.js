sap.ui.define(
    [
        'resourceRequestLibrary/resourceRequestLibrary/model/WeekCalendarModel',
        'resourceRequestLibrary/resourceRequestLibrary/test/unit/helper/FakeI18nModel',
        'sap/ui/thirdparty/sinon'
    ],
    function (WeekCalendarModel, FakeI18nModel, sinon) {
        let oI18nedModel;
        let oi18nModelData;
        QUnit.module('Model QUnit | Week Calendar Model', {
            before: function () {
                oi18nModelData = {
        ...
        QUnit.test('Test checkValidDates - Invalid date', async function (assert) {
            ...
            const observedResult = WeekCalendarModel.checkValidDates(
                new Date(2021, 5, 25),
                new Date(2021, 5, 30),
                new Date(2021, 5, 22),
                new Date(2021, 5, 24),

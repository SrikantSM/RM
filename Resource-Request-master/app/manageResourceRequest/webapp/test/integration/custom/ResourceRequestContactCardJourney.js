sap.ui.define([
    ...
    QUnit.module('Manage Resource Request - Contact Card Journey');
    ...
    opaTest('Validate Contact Card Details in Assigned Resources', function (Given, When, Then) {
        ...
        Then.onTheResourceRequestObjectPage
            ...
            .and.iShouldSeeTheElementTypeWithProperty('sap.m.Avatar', { src: "../manageResourceRequest/odata/v4/ManageResourceRequestService/ConsultantProfileHeaders(3f5eec34-046a-11ea-8d71-362b9e155667)/profilePhoto/profileThumbnail", initials: "SA", displayShape: AvatarShape.Circle, displaySize: AvatarSize.XS, showBorder: true });
        When.onTheResourceRequestObjectPage
        ...
        Then.onTheResourceRequestObjectPage
            ...
            .and.iShouldSeeTheElementTypeWithProperty('sap.m.Avatar', { src: "../manageResourceRequest/odata/v4/ManageResourceRequestService/ConsultantProfileHeaders(3f5eec34-046a-11ea-8d71-362b9e155667)/profilePhoto/profileThumbnail", initials: "SA", displayShape: AvatarShape.Circle, displaySize: AvatarSize.S, showBorder: true })
    ...
    opaTest('Manage Resource Request - Teardown', function (Given, When, Then) {

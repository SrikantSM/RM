...
], function (Opa5, Press, Properties, Ancestor, Descendant, ObjectPage, EnterText) {


    var PREFIX_ID = 'manageResourceRequest::ResourceRequestObjectPage--';
    var AdditionalCustomObjectPageDefinition = {
        actions: {
            iClickOnThePin: function () {
                this.waitFor({
                    id: "manageResourceRequest::ResourceRequestObjectPage--fe::ObjectPage-OPHeaderContent-pinBtn-img",
                    actions: new Press()
                });
            },
            ...
            iClickOnStackedBarChart: function() {
                return this.waitFor({
                    controlType: "sap.suite.ui.microchart.StackedBarMicroChartBar",
